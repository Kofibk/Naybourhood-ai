        ...
        <CardContent className="space-y-4">
          <div className="flex items-center gap-4">
            <div className="h-16 w-16 rounded-full bg-emerald-400/20 flex items-center justify-center">
              <span className="text-2xl font-semibold text-emerald-400">R</span>
            </div>
            <div>
              <p className="text-lg font-medium text-white">{DEMO_USER.name}</p>
              <p className="text-sm text-white/50">{DEMO_USER.email}</p>
              <div className="flex items-center gap-2 mt-1">
                <Badge variant="success">Sales Manager</Badge>
      ...
      <Card className="bg-[#111111] border-white/10">
        ...
        <CardContent className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <span className="text-sm font-medium text-white">{DEMO_COMPANY.name}</span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-sm text-white/50">Plan</span>
            <Badge variant="success">Growth - £899/mo</Badge>
          </div>
          <div className="flex items-center justify-between">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-sm text-white/70">1 March 2026</span>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent>
          <div className="flex items-center justify-between py-2">
            <div>
              ...
              <p className="text-xs text-white/40 font-mono">nb_live_****...****7f3a</p>
            </div>
