...
const DEMO_CONVERSATIONS = [
  {
    ...
    channel: 'whatsapp',
    lastMessage: 'Hi Rowena, confirming I can make the viewing at One Clapham on Friday at 2pm. Will my solicitor need to be present?',
    time: '10 min ago',
  ...
  },
  {
    ...
    name: 'Emily Thornton',
    channel: 'email',
    lastMessage: 'Thank you for the updated pricing schedule. We would like to proceed with the offer on the 3-bed unit at The Edit. Please find attached our solicitors details.',
    time: '1h ago',
    status: 'Negotiating',
    unread: true,
  },
  {
    ...
    name: 'Sarah Chen',
    channel: 'whatsapp',
    lastMessage: 'I have transferred the reservation deposit. Please confirm receipt. Also interested in seeing the penthouse at One Clapham if still available.',
    time: '3h ago',
    status: 'Follow Up',
    unread: false,
  },
  {
    ...
    channel: 'phone',
    lastMessage: 'Call completed — 12 min. Discussed The Edit 2-bed options. Sending brochure and floor plans via email.',
    time: '5h ago',
    status: 'Viewing Booked',
    unread: false,
  },
  ...
  },
  {
    ...
    channel: 'email',
    lastMessage: 'Following up on our conversation about The Broadley. Could you share the latest availability and the investor pricing?',
    time: 'Yesterday',
    status: 'Follow Up',
    unread: false,
  },
  {
    ...
    name: 'Priya Sharma',
    channel: 'phone',
    lastMessage: 'Missed call. Left voicemail about One Clapham 2-bed availability near Waterloo.',
    time: '2d ago',
    status: 'Contact Pending',
    unread: false,
  },
