...
export default function SBDemoBuyersImportPage() {
        ...
        <Card className="bg-[#111111] border-white/10">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center gap-2 p-3 bg-emerald-500/10 border border-emerald-500/30 rounded-lg">
              ...
              <div>
                <p className="text-sm font-medium text-white">smart_bricks_leads_feb2026.csv</p>
                <p className="text-xs text-white/50">384 rows detected · 14 columns</p>
              </div>
            </div>
      ...
      {step === 'complete' && (
        <Card className="bg-[#111111] border-white/10">
          <CardContent className="py-12 text-center">
            ...
            <p className="text-sm text-white/50 mb-1">384 buyers imported successfully</p>
