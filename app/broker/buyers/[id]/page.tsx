...
export default function BrokerBuyerDetailPage() {
  ...
  if (!lead) {
    return (
      <div className="space-y-6">
        <Link href="/broker/buyers" className="flex items-center gap-2 text-white/40 hover:text-white transition-colors">
        ...
        <div className="bg-[#111111] border border-white/10 rounded-xl py-12 text-center">
          ...
          <Button onClick={() => router.push('/broker/buyers')}>Back to Clients</Button>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="flex justify-between items-start">
        <div>
          <Link href="/broker/buyers" className="flex items-center gap-2 text-white/40 hover:text-white transition-colors mb-3">
            <ArrowLeft className="w-4 h-4" /> Back to Clients
          </Link>
