              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="text-left text-xs text-muted-foreground border-b bg-muted/30">
                    <th className="p-3 font-medium min-w-[180px]">Lead</th>
                    <th className="p-3 font-medium min-w-[130px]">Classification</th>
                    <th className="p-3 font-medium min-w-[160px]">Status</th>
                    <th className="p-3 font-medium min-w-[180px]">Next Action</th>
                    <th className="p-3 font-medium text-right min-w-[130px]">Quick Actions</th>
                  </tr>
                </thead>
                <tbody>
                  {leads.map((lead) => (
                    ...
                    >
                      ...
                      <td className="py-3" onClick={(e) => e.stopPropagation()}>
                        <select
                          ...
                          className="text-sm px-3 py-1.5 rounded-md border border-input bg-background cursor-pointer hover:bg-muted transition-colors min-w-[150px] font-medium"
                        >
